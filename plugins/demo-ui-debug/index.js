  ...
  const renderDetail = (p) => {
    ...
    return h('div', null,
      ...
      p.error_msg ? h('div', { style: { marginTop: 8 } },
        ...
        h('div', { style: { background: '#fff1f0', padding: 8, borderRadius: 4, whiteSpace: 'pre-wrap', wordBreak: 'break-all' } }, p.error_msg)) : null,
      p.error_stack ? h('div', { style: { marginTop: 8 } },
        h(Typography.Text, { type: 'danger', strong: true }, '错误堆栈：'),
        h('pre', { style: { background: '#fafafa', padding: 8, borderRadius: 4, whiteSpace: 'pre-wrap', maxHeight: 300, overflow: 'auto', fontSize: 12 } }, p.error_stack)) : null,
